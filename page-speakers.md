...
<button class="accordion"><i class="far fa-comments" style="position: relative; top: -5px; text-indent: 0px; vertical-align: middle; color:white"></i>&nbsp;&nbsp;Abstract: Diving Into Metascience – Doing Research on Research</button>
<div class="panel">
  <p align="justify" style="font-family: arial;"><br></p>
</div>
</td>
<td>
<button class="accordion"><i class="fas fa-id-card" style="position: relative; top: -5px; text-indent: 0px; vertical-align: middle; color:white"></i>&nbsp;&nbsp;Bio</button>
...
<button class="accordion"><i class="far fa-comments" style="position: relative; top: -5px; text-indent: 0px; vertical-align: middle; color:white"></i>&nbsp;&nbsp;Abstract: Analytic flexibility and questionable research practices in MRI</button>
<div class="panel">
