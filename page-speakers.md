...
<button class="accordion"><i class="far fa-comments" style="position: relative; top: -5px; text-indent: 0px; vertical-align: middle; color:white"></i>&nbsp;&nbsp;Abstract: <b>Analytical Flexibility and Questionable Research Practices in MRI</b></button>
<div class="panel">
...
<button class="accordion"><i class="far fa-comments" style="position: relative; top: -5px; text-indent: 0px; vertical-align: middle; color:white"></i>&nbsp;&nbsp;Abstract: <b>Where to Go Next? The Landscape of Post-PhD Career Tracks
</b></button>
<div class="panel">
